...
CREATE TABLE CLASS(USN INT,SSID INT,FOREIGN KEY(USN) REFERENCES STUDENT(USN),FOREIGN KEY(SSID) REFERENCES SEM_SEC(SSID));

CREATE TABLE SUBJECTS(SUBCODE INT,TITLE VARCHAR(20),SEM INT,CREDITS INT,PRIMARY KEY(SUBCODE));

CREATE TABLE MARKS(USN INT,SUBCODE INT,SSID INT,TEST1 INT,TEST2 INT,TEST3 INT,FOREIGN KEY(USN) REFERENCES STUDENT(USN),FOREIGN KEY(SSID) REFERENCES SEM_SEC(SSID),FOREIGN KEY(SUBCODE) REFERENCES SUBJECTS(SUBCODE));
