...
/*NOT DONE*/
SELECT A.A_ID,A.A_NAME FROM AIRCRAFT A,CERTIFIED C WHERE C.A_ID=A.A_ID AND C.E_ID=ALL(SELECT E_ID FROM EMPLOYEE WHERE E_ID IN (SELECT E_ID FROM CERTIFIED) AND SALARY>80000);
