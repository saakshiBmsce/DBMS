...
CREATE TABLE ACTOR(ACT_ID INT,ACT_NAME VARCHAR(10),ACT_GENDER VARCHAR(10),PRIMARY KEY(ACT_ID));

CREATE TABLE DIRECTOR(DIR_ID INT,DIR_NAME VARCHAR(10),DIR_PHONE INT,PRIMARY KEY(DIR_ID));

CREATE TABLE MOVIES(MOV_ID INT,MOV_TITLE VARCHAR(10),MOV_YEAR VARCHAR(10),MOV_LANG VARCHAR(10),DIR_ID INT,PRIMARY KEY(MOV_ID),FOREIGN KEY(DIR_ID) REFERENCES DIRECTOR(DIR_ID));

CREATE TABLE MOVIE_CAST(ACT_ID INT,MOV_ID INT,ROLE_PLAYED VARCHAR(10),FOREIGN KEY(ACT_ID) REFERENCES ACTOR(ACT_ID),FOREIGN KEY(MOV_ID) REFERENCES MOVIES(MOV_ID));

CREATE TABLE RATING(MOV_ID INT,REV_STARS FLOAT,FOREIGN KEY(MOV_ID) REFERENCES MOVIES(MOV_ID));

INSERT INTO ACTOR VALUES(1,'TOM HANKS','MALE');
INSERT INTO ACTOR VALUES(2,'DEEPIKA','FEMALE');
INSERT INTO ACTOR VALUES(3,'SRK','MALE');
INSERT INTO ACTOR VALUES(4,'BRAD PITT','MALE');
INSERT INTO ACTOR VALUES(5,'SHRADDHA','FEMALE');
SELECT * FROM ACTOR;

INSERT INTO DIRECTOR VALUES(10,'HITCHCOCK',241342);
INSERT INTO DIRECTOR VALUES(20,'STEVEN',241829);
INSERT INTO DIRECTOR VALUES(30,'CLINT',247382);
INSERT INTO DIRECTOR VALUES(40,'ROBERT',241666);
...
INSERT INTO MOVIE_CAST VALUES(2,44,'VILLIAN');
INSERT INTO MOVIE_CAST VALUES(5,55,'VILLIAN');
...
SELECT D.DIR_NAME,M.MOV_TITLE FROM DIRECTOR D,MOVIES M WHERE D.DIR_ID=M.DIR_ID AND D.DIR_NAME='HITCHCOCK';
